-- ============================================================
-- Hostinger / live MySQL setup (safe for phpMyAdmin)
-- ============================================================
-- How to run:
-- 1. Open phpMyAdmin → select database u257087873_beverage_vault
-- 2. SQL tab → paste this file → Go
-- Do NOT run CREATE DATABASE / USE — Hostinger already created your DB.
...
CREATE TABLE IF NOT EXISTS classic_cocktails (
  id                    CHAR(36)     NOT NULL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS signature_cocktails (
  id                    CHAR(36)     NOT NULL PRIMARY KEY,
  slug                  VARCHAR(160) NOT NULL UNIQUE,
